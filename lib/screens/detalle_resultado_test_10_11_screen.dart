...
class _DetalleResultadoTest1011ScreenState extends State<DetalleResultadoTest1011Screen> {
  ...
  Map<String, int> _analizarRespuestas() {
    ...
    if (respuestas is Map) {
      respuestas.forEach((key, value) {
        ...
        if (valorStr.contains('A')) meGusta++;
        else if (valorStr.contains('B')) meInteresa++;
        else if (valorStr.contains('C')) noMeGusta++;
      });
    }
    return {
      'Me gusta': meGusta,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFE8F4F8), // Celeste claro como tu home
      appBar: AppBar(
        elevation: 0,
        backgroundColor: const Color(0xFF42A5F5), // Azul celeste
        title: Text(
  ...
  List<PieChartSectionData> _buildPieChartSections(Map<String, int> conteo, bool isTablet) {
    ...
    return [
      ...
      PieChartSectionData(
        color: const Color(0xFF42A5F5), // Azul celeste
      ...
      PieChartSectionData(
        color: const Color(0xFFFF7043), // Naranja
  ...
  Widget _buildLegend(Map<String, int> conteo) {
    ...
    return Column(
      children: [
        _buildLegendItem('Me gusta', meGusta, const Color(0xFF66BB6A)),
        const SizedBox(height: 12),
        _buildLegendItem('Me interesa', meInteresa, const Color(0xFF42A5F5)),
        const SizedBox(height: 12),
